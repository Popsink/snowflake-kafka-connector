...
public final class Constants {
  ...
  public static final class KafkaConnectorConfigParams {
    ...
    public static final String SNOWFLAKE_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION =
        "snowflake.enable.autogenerated.table.name.sanitization";
    public static final boolean SNOWFLAKE_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION_DEFAULT =
        true;
    // MDC logging header
